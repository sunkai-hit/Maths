...
withTopic('三角形单元综合',t=>{
 ...
 t.questions[0].diagram=midTri;
});
withTopic('等腰三角形的性质与分类讨论',t=>{
 t.questions[2].diagram={...midTri,points:{...midTri.points,E:[4,2]},lines:[...midTri.lines,['B','E'],['C','E']]};
});
withTopic('轴对称单元综合',t=>{t.example.diagram=midTri;});
withTopic('勾股定理求边与面积',t=>{
 t.example.diagram={points:{A:[0,6,-15,-8],B:[8,0,6,16],C:[0,0,-15,16]},lines:[['A','B'],['B','C'],['C','A']],bounds:[-1,9,-1,7],label:'直角三角形 ABC，C 为直角顶点'};
});
withTopic('坐标中的线段与图形面积',t=>{
 t.example.diagram={points:{A:[-2,0,-22,19],B:[4,0,5,19],C:[1,3],O:[0,0,5,19]},lines:[['A','B'],['B','C'],['C','A']],bounds:[-3,5,-1,4],axes:true,label:'坐标系中的 A(-2,0)、B(4,0)、C(1,3)'};
});
withTopic('描点作图与坐标轴交点',t=>{
 t.example.diagram={points:{A:[2,0,6,19],B:[0,4],O:[0,0,-15,19]},graph:[[-2,4,-0.5,2.5]],bounds:[-1,4,-2,6],axes:true,label:'直线 y=-2x+4，与两坐标轴交于 A(2,0)、B(0,4)'};
});
withTopic('一次函数与方程、不等式',t=>{
 t.questions[2].diagram={points:{A:[-2,0,-20,19],B:[4,0,6,19],P:[2,4],O:[0,0,5,19]},lines:[['A','B'],['A','P'],['P','B']],bounds:[-3,5,-1,5],axes:true,label:'两直线交点 P(2,4)，与 x 轴交于 A(-2,0)、B(4,0)'};
});
