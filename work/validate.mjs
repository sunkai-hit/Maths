...
const files=['data.js','chapter2.js','chapter3.js','chapter4.js','chapter5.js','chapter6.js','reviews.js','diagrams.js'];
...
assert.equal(topics.find(t=>t.name==='三边关系与第三边范围').questions[1].answer,String(Array.from({length:14},(_,x)=>x).filter(x=>x>3&&x<13&&x%2===0).length));
